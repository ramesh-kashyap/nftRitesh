          ...
          <div class="nft-horizontal-box">
            <div class="product-details">
              ...
              <div class="product-image">
                <img class="img-fluid" src="assets/images/product/download.png" alt="security" />
              </div>
              <div class="product-content">
                <div>
                  <h4>3D Art</h4>
        ...
        <ul class="nav nav-tabs tab-style2" id="myTab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="token-tab" data-bs-toggle="tab" data-bs-target="#token-tab-pane"
              type="button" role="tab">Token</button>
          </li>
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="itc-tab" data-bs-toggle="tab" data-bs-target="#itc-tab-pane" type="button"
              role="tab">ITC</button>
          </li>
        </ul>
      </div>
