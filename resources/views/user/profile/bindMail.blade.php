        ...
        <div class="tf-container">
            <div class="mb-24 pb-24 line-3">
                <div class="card pb-20">
                    <form method="POST" action="{{ route('user.bindemail-action') }}"  class="auth-form">
                        {{ csrf_field() }}
                        <div class="card-body">
                            ...
                            <div class="delete-item mt-20 ">
                                ...
                                <input class="mt-12 form-control" type="email" id="emailId" value="{{Auth::user()->email}}" type="email" name="emailId"  placeholder="Enter your email">
                                <i class="ri-user-line user"></i>
                            </div>
                            <div class="delete-item mt-20 ">
                                <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="code-btn text-primary" style="position: absolute; top: 45%; right: 26px; cursor: pointer;">Get Code</span>
                                <i class="ri-user-line user"></i>
                            </div>
