...
<body>
        ...
        <div class="tf-container">
            <div class="mb-24 pb-24 line-3">
                <div class="card pb-20">
                    <form method="POST" action="{{ route('user.change-trxpasswword') }}" class="auth-form">
                        {{ csrf_field() }}
    ...
    font-size: 16px;
    font-weight: 500;">Current Email</span>

                                </div>
                                <input class="mt-12 form-control" name="email" type="text"   value="{{Auth::user()->email}}" readonly>
...
">Get Code</span>
                          ...
                          <div class="delete-item mt-20 ">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="body-4" style="
font-size: 16px;
font-weight: 500;">Transaction password</span>
