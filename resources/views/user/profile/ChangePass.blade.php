...
<body>
  ...
  <section class="section-t-space section-lg-b-space">  
    ...
    <div class="details" style="padding-bottom:10px;">
      ...
      <form method="post" action="{{ route('user.edit-password') }}" class="auth-form create-form" >
      {{ csrf_field()}}
        ...
        <div class="form-group mb-3">
          <label for="inputusername" class="form-label">@lang('New password')</label>
          <div class="form-input">
        ...
        <div class="form-group mb-3">
          ...
          <div class="form-input">
            <input type="password" class="form-control" id="inputPassword" name="password_confirmation" placeholder="Please confirm the login password"/>
