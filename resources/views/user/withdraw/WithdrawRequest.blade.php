...
<body>
  ...
  <section class="section-t-space section-lg-b-space">
    ...
    <form action="{{ route('user.Withdraw-Request') }}" method="POST" class="auth-form offer-form">
                            {{ csrf_field() }}
	  ...
	  <div class="mb-3 mt-3">
      <input type="text"   name="walletAddress"  value="{{Auth::user()->usdtBep20}}"class="form-control" id="datepicker"/>
      </div>
      ...
      placeholder="Enter amount"class="form-control" id="datepicker"/>
      </div>
        <div class="message-body">
          <ul>
            <li>@lang('Available for Withdrawal'):  {{ number_format(Auth::user()->available_balance(), 2) }} USDT </li>
            ...
            <p style="color:white;">@lang('New user fund protection period,') <span id="PH_days"></span> Days <span id="PH_hours"></span> Hours</span><span data-v-c654d101=""> </p>
          </ul>
      ...
      @if(date("Y-m-d H:i:s") > $new_date1) 
                                    <div data-v-e1c9eb74="" class="code-btn" style="margin-left: 475px; color:white;">Get Code</div>
      ...
      <input  name="code" type="text" placeholder="Enter verification code" class="form-control" id="datepicker"/>
      </div>
