...
<body class="counter-scroll">
    ...
    <div class="app-content style-2">
        <div class="px-24 card-layout style-2">
            ...
            @foreach ($nfts as $nft)
                ...
                <div class="mt-20">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-4">
                        <span class="button-2 text-blue">Hape_NFT</span>
            ...
            <div class="pb-24 mb-24 line">
                <div class="d-flex gap-14 tf-counter">
                    ...
                    <div class="counter-box visitor count-style-2">
                        ...
                        <div class="count-number">                                  
                            <span class="number" data-speed="1000" data-dec="3" data-to="2.820" data-inviewport="yes">2,820</span>                                   
                        </div>
            ...
            <div class="pb-24 mb-24 line">
                <p class="body-3 text-dark-2">Ends on Thursday, November 17, 2022 at 19.00 PM GMT+ 07.00. Time left -</p>
            ...
            <div class="wrap-slider-tab">
                <div class="wrapper-tab-nft style-2">
                    <ul class="nav nav-tabs tab-1" role="tablist" >
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#listings">Listings</button>
                        </li> 
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#activity">Item Activity</button>
                        </li> 
            ...
            <div class="tab-content mt-28">
                <div class="tab-pane fade active show" id="details" role="tabpanel">
                    <div class="card-nft-1">
                        ...
                        <div id="collection" class="accordion-collapse collapse show" aria-labelledby="collection">
                            <div class="card-body">
                                ...
                                <p class="mt-20 text-dark-2">An online community of makers, developers, and traders is pushing the art world into new territory. It all started with <span class="text-primary fw-6">Read More...</span></p>
                    ...
                    <div class="card-nft-1 mt-24">
                        <div class="card-header" data-bs-toggle="collapse" data-bs-target="#properties" aria-expanded="true" aria-controls="properties">
                            <h6>Properties</h6>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19.9201 8.94922L13.4001 15.4692C12.6301 16.2392 11.3701 16.2392 10.6001 15.4692L4.08008 8.94922" stroke="#1A1528" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>    
                    ...
                    <div class="card-nft-1 mt-24">
                        <div class="card-header" data-bs-toggle="collapse" data-bs-target="#price-history" aria-expanded="true" aria-controls="price-history">
                            <h6>Price History</h6>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19.9201 8.94922L13.4001 15.4692C12.6301 16.2392 11.3701 16.2392 10.6001 15.4692L4.08008 8.94922" stroke="#1A1528" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>    
                        </div>
                        <div id="price-history" class="accordion-collapse collapse show" aria-labelledby="price-history">
                            <div class="card-body wrap-chart">
                                <div class="top">
                                    <div class="nice-select tf-select-v2" tabindex="0"><span class="current">Last Month</span>
                                        <ul class="list">  
                ...
                <div class="tab-pane fade" id="offers" role="tabpanel">
                    ...
                    <div class="card-nft-2">
                        <div class="card-header"  data-bs-toggle="collapse" data-bs-target="#offers-1" aria-expanded="true" aria-controls="offers-1">
                            <div class="content-left">
                    ...
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#offers-2" aria-expanded="true" aria-controls="offers-2">
                            <div class="content-left">
                    ...
                    <!-- item 3 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#offers-3" aria-expanded="true" aria-controls="offers-3">
                            <div class="content-left">
                    ...
                    <!-- item 4 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#offers-4" aria-expanded="true" aria-controls="offers-4">
                            <div class="content-left">
                    ...
                    <!-- item 5 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#offers-5" aria-expanded="true" aria-controls="offers-5">
                            <div class="content-left">
                    ...
                    <!-- item 6 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#offers-6" aria-expanded="true" aria-controls="offers-6">
                            <div class="content-left">
                    ...
                    <!-- item 7 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#offers-7" aria-expanded="true" aria-controls="offers-7">
                            <div class="content-left">
                    ...
                    <!-- item 8 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#offers-8" aria-expanded="true" aria-controls="offers-8">
                            <div class="content-left">
                    ...
                    <!-- item 9 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#offers-9" aria-expanded="true" aria-controls="offers-9">
                            <div class="content-left">
                    ...
                    <!-- item 10 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#offers-10" aria-expanded="true" aria-controls="offers-10">
                            <div class="content-left">
                ...
                <div class="tab-pane fade" id="listings" role="tabpanel">
                    <!-- item 1 -->
                    <div class="card-nft-2">
                        <div class="card-header" data-bs-toggle="collapse" data-bs-target="#listings-1" aria-expanded="true" aria-controls="listings-1">
                            <div class="content-left">
                    ...
                    <!-- item 2 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#listings-2" aria-expanded="true" aria-controls="listings-2">
                            <div class="content-left">
                                <div class="button-1">Claith_ETH</div>
                                <span class="less button-3">-less</span>
                                <span class="more button-3">+more</span>
                    ...
                    <!-- item 3 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#listings-3" aria-expanded="true" aria-controls="listings-3">
                            <div class="content-left">
                                <div class="button-1">Claith_ETH</div>
                                <span class="less button-3">-less</span>
                                <span class="more button-3">+more</span>
                    ...
                    <!-- item 4 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#listings-4" aria-expanded="true" aria-controls="listings-4">
                            <div class="content-left">
                                <div class="button-1">Claith_ETH</div>
                                <span class="less button-3">-less</span>
                                <span class="more button-3">+more</span>
                    ...
                    <!-- item 5 -->
                    <div class="card-nft-2 mt-20">
                        <div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#listings-5" aria-expanded="true" aria-controls="listings-5">
                            <div class="content-left">
                                <div class="button-1">Claith_ETH</div>
                                <span class="less button-3">-less</span>
                                <span class="more button-3">+more</span>
                ...
                <div class="tab-pane fade check-list" id="activity" role="tabpanel">
                    ...
                    <div class="card-nft-2 style-2">
                        <div class="card-header" data-bs-toggle="collapse" data-bs-target="#activity-1" aria-expanded="true" aria-controls="activity-1">
                            <div class="content-left">
                                <div class="d-flex gap-16 align-items-center">
                                    <i class="icon icon-bag-2"></i>
                                    <div>
                    ...
                    <div class="card-nft-2 style-2 mt-20">
                        <div class="card-header" data-bs-toggle="collapse" data-bs-target="#activity-2" aria-expanded="true" aria-controls="activity-2">
                            <div class="content-left">
                                <div class="d-flex gap-16 align-items-center">
                    ...
                    <div class="card-nft-2 style-3 mt-20">
                        <div class="card-header" data-bs-toggle="collapse" data-bs-target="#activity-3" aria-expanded="true" aria-controls="activity-3">
                            <div class="content-left">
                                <div class="d-flex gap-16 align-items-center">
                    ...
                    <!-- item 4 -->
                    <div class="card-nft-2 style-2 mt-20">
                        <div class="card-header" data-bs-toggle="collapse" data-bs-target="#activity-4" aria-expanded="true" aria-controls="activity-4">
                            <div class="content-left">
                                <div class="d-flex gap-16 align-items-center">
    ...
    <div class="btn-fixed">
        <div class="grid-2 gap-15">
            <a href="make-offer.html" class="tf-btn disabled-primary btn-icon"><span class="icon icon-ticket-star"></span> Make Offer</a>
            <a href="buy-now.html" class="tf-btn primary btn-icon"><span class="icon icon-wallet-money"></span> Buy Now</a>
