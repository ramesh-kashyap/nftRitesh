...
<body>
    ...
    <div class="preload preload-container">
        <div class="logo-img">
            <svg width="172" height="49" viewBox="0 0 172 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                    d="M9.04785 22.6666C9.04785 21.362 9.26527 20.128 9.7001 18.9644C10.1712 17.8008 10.8234 16.7783 11.6569 15.8969C12.5265 15.0154 13.5411 14.3278 14.7007 13.8342C15.8965 13.3406 17.2191 13.0938 18.6686 13.0938V19.0702C18.0163 19.0702 17.4365 19.2288 16.9292 19.5462C16.4219 19.8635 16.0233 20.3219 15.7334 20.9213C15.4435 21.5207 15.2986 22.2082 15.2986 22.9839V34.9985H9.04785V22.6666ZM24.7562 22.9839C24.7562 22.2788 24.6113 21.6265 24.3214 21.0271C24.0677 20.4277 23.6873 19.9517 23.18 19.5991C22.6727 19.2465 22.0566 19.0702 21.3319 19.0702V13.0938C22.7814 13.0938 24.0859 13.3406 25.2454 13.8342C26.4412 14.3278 27.4558 15.0154 28.2893 15.8969C29.1589 16.7783 29.8112 17.8008 30.246 18.9644C30.7171 20.128 30.9526 21.362 30.9526 22.6666V34.9985H24.7562V22.9839Z"
                    fill="#7F52FF" />
                <path
                    d="M19.9995 15.2852C19.9995 15.2852 20.06 15.8492 20.2953 16.0846C20.5307 16.32 21.0948 16.3804 21.0948 16.3804C21.0948 16.3804 20.5307 16.4408 20.2953 16.6762C20.06 16.9116 19.9995 17.4756 19.9995 17.4756C19.9995 17.4756 19.9391 16.9116 19.7037 16.6762C19.4683 16.4408 18.9043 16.3804 18.9043 16.3804C18.9043 16.3804 19.4683 16.32 19.7037 16.0846C19.9391 15.8492 19.9995 15.2852 19.9995 15.2852Z"
                    fill="#7F52FF" />
                <path
                    d="M19.9996 28.4297C19.9996 28.4297 20.1809 30.1218 20.887 30.828C21.5932 31.5341 23.2853 31.7154 23.2853 31.7154C23.2853 31.7154 21.5932 31.8967 20.887 32.6028C20.1809 33.309 19.9996 35.0011 19.9996 35.0011C19.9996 35.0011 19.8183 33.309 19.1121 32.6028C18.406 31.8967 16.7139 31.7154 16.7139 31.7154C16.7139 31.7154 18.406 31.5341 19.1121 30.828C19.8183 30.1218 19.9996 28.4297 19.9996 28.4297Z"
                    fill="#7F52FF" />
                <path
                    d="M20 21.8555C20 21.8555 20.1209 22.9836 20.5917 23.4543C21.0624 23.9251 22.1905 24.0459 22.1905 24.0459C22.1905 24.0459 21.0624 24.1668 20.5917 24.6376C20.1209 25.1083 20 26.2364 20 26.2364C20 26.2364 19.8792 25.1083 19.4084 24.6376C18.9377 24.1668 17.8096 24.0459 17.8096 24.0459C17.8096 24.0459 18.9377 23.9251 19.4084 23.4543C19.8792 22.9836 20 21.8555 20 21.8555Z"
                    fill="#7F52FF" />
                <path
                    d="M11.2383 28.4289C11.2383 28.4289 10.1102 28.3081 9.63948 27.8373C9.23659 27.3641 9.07719 26.5741 9.04785 26.2383V30.6194C9.04785 30.6194 9.16871 29.4913 9.63948 29.0205C10.1102 28.5498 11.2383 28.4289 11.2383 28.4289Z"
                    fill="white" />
                <path
                    d="M11.7305 19.0657C11.7305 19.0657 10.6721 18.657 10.3393 18.0805C10.0726 17.5191 10.1231 16.7148 10.1816 16.3828L9.04773 20.6146C9.04773 20.6146 9.45644 19.5563 10.033 19.2234C10.6096 18.8905 11.7305 19.0657 11.7305 19.0657Z"
                    fill="white" />
                <path
                    d="M28.7617 24.0476C28.7617 24.0476 29.8898 24.1685 30.3605 24.6393C30.7634 25.1125 30.9228 25.9024 30.9521 26.2383L30.9521 21.8572C30.9521 21.8572 30.8313 22.9853 30.3605 23.456C29.8898 23.9268 28.7617 24.0476 28.7617 24.0476Z"
                    fill="white" />
                <path
                    d="M25.1824 16.0868C25.1824 16.0868 25.8511 15.1703 26.4942 14.998C27.1054 14.8857 27.8693 15.1426 28.1748 15.2852L24.3807 13.0946C24.3807 13.0946 25.2972 13.7633 25.4695 14.4064C25.6418 15.0495 25.1824 16.0868 25.1824 16.0868Z"
                    fill="white" />
                <path
                    d="M15.325 14.9923C15.325 14.9923 14.8657 13.9549 15.038 13.3119C15.2463 12.7264 15.8508 12.1933 16.127 12L12.3328 14.1906C12.3328 14.1906 13.3702 13.7312 14.0133 13.9035C14.6563 14.0758 15.325 14.9923 15.325 14.9923Z"
                    fill="white" />
                <path
                    d="M28.7617 32.8094C28.7617 32.8094 29.8898 32.9302 30.3605 33.401C30.7634 33.8742 30.9228 34.6642 30.9521 35L30.9521 30.6189C30.9521 30.6189 30.8313 31.747 30.3605 32.2177C29.8898 32.6885 28.7617 32.8094 28.7617 32.8094Z"
                    fill="white" />
            </svg>
        </div>
    ...
    <div>
        <div class="header fixed-top">
            <div class="left">
                <a href="http://127.0.0.1:8000/user/dashboard"><i class="icon-close2"></i></a>
            </div>
            <h3>My Team</h3>
            <div class="right">
                    ...
                    <div class="tab-content mt-24">
                            ...
                            <ul class="list-view check-list">
                                ...
                                <li class="item">
                                    ...
                                    <a href="#" class="gap-12">
                                        ...
                                        <span class="content">
                                            <span class="body-1">@lang('Deposit')</span>
                                            </br>
                                            <span class="body-1">@lang('Username')</span>


                                            <br>
                                            <span class="body-1">@lang('Status')</span>
                                            </br>
                                        ...
                                        <div class="col-sm-2 ">
                                            <span class="body-1"
                                                style="font-size: 13px;">{{ ($value->investment->sum('amount'))?$value->investment->sum('amount'):0 }}
                                                USDT </span></br>
                                            <span class="body-1" style="font-size: 13px;">{{ $value->username }}
                                            </span></br>
                                          
                                                @if($value->active_status == "Pending")
                                            
                                            <div class="col-sm-6 ">
                                                <button class="tf-btn btn-sm info">{{ $value->active_status }}</button>
                                            </div>
                                           
                                            @else
                                            <div class="col-sm-6 ">
                                                <button class="tf-btn btn-sm {{ $value->active_status == 'Approved' ? 'success' : 'danger' }}">{{ $value->active_status }}</button>
                                            </div>
                                            @endif
                            ...
                            <ul class="list-view check-list">
                                ...
                                <li class="item">
                                    <a href="#" class="gap-12">
                                        ...
                                        <span class="content">
                                            <span class="body-1">200 USDT</span>
                                            <span class="body-4 mt-4 tid">（TID: 41b795c74d501df59c6360f5e0f3caff）</span>

                                            <br>
                                            <span class="body-1" style="font-size: 13px;">Thu, 01 Jan 1970 00:00:00
                                            </span>

                                        </span>

                                        <div class="col-sm-2 ">
                                            <button class="tf-btn btn-sm info">Pending</button>
                                        </div>
                        ...
                        <style>
                            .tid {
                                ...
                                /* Ensure it's treated as a block element for scrolling */
                                max-width: 150px;
                            ...
                            .tid:hover {
                                overflow-x: auto;
                                /* Show horizontal scroll on hover */
                            }
