                                        ...
                                        <a href="#" class="gap-12">
                                            ...
                                            <span class="content">
                                                ...
                                                <span class="body-1">@lang('Status')</span>
                                                                                        ...
                                                                                        <div class="col-sm-2 ">
                                                                                        <span class="body-1" style="font-size: 13px;">{{ ($value->investment->sum('amount'))?$value->investment->sum('amount'):0 }} USDT </span></br>
                                                                                        <span class="body-1" style="font-size: 13px;">{{ $value->username }} </span></br>
                                                                                        <span
                                    ...
                                    <li class="item">
                                        <a href="#" class="gap-12">
                                            ...
                                            <span class="content">
                                                ...
                                                <br>
                                                <span class="body-1" style="font-size: 13px;">Thu, 01 Jan 1970 00:00:00 </span>
