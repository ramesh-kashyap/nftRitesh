                        ...
                        >
                            <div class="swiper-wrapper" style="justify-content: end;">
                                <div class="swiper-slide">
                                    <a href="#categories" data-bs-toggle="offcanvas"  aria-controls="offcanvasBottom" class="category-select"><span>Team</span> <i class="icon icon-left-arr"></i></a>
                                </div>
  ...
  @for ($l=1;$l<=3;$l++)
      ...
      <div class="offcanvas-body">
          ...
          <?php echo  (Session::get('selected_level')==$l)?"":""?>
            <a  style="color: <?php echo  (Session::get('selected_level')==$l)?"#":"#000"?>" href="{{route('user.referral-team') }}?selected_level={{$l}}" >Lvl {{$l}}</a>
          </fieldset>
