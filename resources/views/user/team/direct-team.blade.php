                        ...
                        <div class="swiper tf-sw sw-auto sw-lr" data-preview="auto" data-space="16">
                            ...
                            @for ($l=1;$l<=3;$l++)
                                ...
                                <div class="swiper-slide">
                                    <a  data-bs-toggle="offcanvas"  aria-controls="offcanvasBottom" class="category-select"><?php echo  (Session::get('selected_level')==$l)?"":""?> <a style="color: <?php echo  (Session::get('selected_level')==$l)?"green":"#000"?>" href="{{route('user.referral-team') }}?selected_level={{$l}}" ><span>@lang('Level') {{$l}}</span> 
                                   </a>
                                </div>  @endfor
...
@foreach ($direct_team as $value)
                                        <div class="content-left">
                                            <p class="button-1">@lang('Deposit')</p>
                                            <span class="more text-primary mt-2 button-3">@lang('Username')</span>
                                        ...
                                        <div class="content-right text-end">
                                            ...
                                            <span class="mt-2 d-block body-4 text-dark-2">{{ $value->username }}</span>
                                        </div>
                                        @endforeach
                                        <?php }?>
                                    </div> 
