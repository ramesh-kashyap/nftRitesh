...
<body>
    ...
    <div class="menubar-footer footer-fixed">
      <ul class="inner-bar">
          ...
          <li><a href="http://127.0.0.1:8000/user/profile">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g opacity="0.6">
          ...
          <div class="modal-content modal-sidebar">
              ...
              <div class="sidebar-content">
                  ...
                  <ul class="pt-20 pb-20">
                      ...
                      <li class="mt-16">
                          <a href="http://127.0.0.1:8000/user/profile" class="nav-link-item not-link">
                              <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                  viewBox="0 0 20 20" fill="none">
                                  <path
              ...
              <div class="overflow-auto">
                  <div class="tf-container">
                      <ul>
                          ...
                          <li><a href="http://127.0.0.1:8000/user/profile" class="nav-link-item pt-16 pb-16 line-bt not-link">
                                  <span>Profile</span>
                              </a></li>
